...
export function NotificationBell() {
  ...
  const notificationsList = (
    <>
      ...
      <ScrollArea className={screen.isMobile ? "h-[60vh]" : "h-[300px]"}>
              ...
              >
                <div className="flex gap-3">
                  ...
                  <Button
                    variant="ghost"
                    size="icon"
                    className={`h-7 w-7 flex-shrink-0 ${screen.isMobile ? "" : "invisible group-hover:visible"}`}
                    onClick={(e) => {
                      e.stopPropagation();
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      ...
      <PopoverContent className="w-80 p-0" align="end" sideOffset={8} alignOffset={-4}>
        {notificationsList}
      </PopoverContent>
    </Popover>
  );
