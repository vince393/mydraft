...
const faqSections: FAQSection[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer: "After completing onboarding, you'll be prompted to connect your email. We support Gmail and Microsoft Outlook. Click the provider you use and authorize MailFlow to access your inbox securely via OAuth."
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer: "We access emails only to display them in MailFlow and to power AI features. Email content is processed in memory and not permanently stored beyond caching for performance."
      },
      {
